...
-- 用户表
CREATE TABLE users (
    username varchar(250) PRIMARY KEY,  -- 用户名
...
CREATE TABLE last (  -- 最后活动(XEP-0012)
...
CREATE TABLE rosterusers (  -- 名册管理 (XMPP IM)
    username varchar(250) NOT NULL,
    jid varchar(250) NOT NULL,  -- admin1@example.org
    nick text NOT NULL,
...
CREATE TABLE vcard (  -- 电子名片 XEP-0054
    username varchar(250) PRIMARY KEY,
    vcard mediumtext NOT NULL,
    created_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB CHARACTER SET utf8;

CREATE TABLE vcard_xupdate (  -- 基于vCard的头像(XEP-0153)mod_vcard 或 mod_vcard_odbc
    username varchar(250) PRIMARY KEY,
    hash text NOT NULL,
    created_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB CHARACTER SET utf8;
...
CREATE TABLE muc_room (  -- Multiple User Chat多用户聊天 (XEP-0045)
    name text NOT NULL,
    host text NOT NULL,
    opts text NOT NULL,
    created_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
